...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const dotConfig = { dotSize: 2, gap: 20, baseColor: '#555555', activeColor: '#cdb89f', proximity: 100 }
  ...
  useEffect(() => {
    ...
    if (!container) return
    const config = { particleCount: 200, particleSpread: 10, speed: 0.1, particleColors: ['#cdb89f'], alphaParticles: true, particleBaseSize: 100, sizeRandomness: 1, cameraDistance: 20, disableRotation: false, pixelRatio: window.devicePixelRatio || 1 }
  ...
  return (
    <>
      ...
      <div className="container">
        ...
        <div className="icons">
          <a href="https://github.com/Mpbooks" target="_blank" rel="noreferrer" title="GitHub">
